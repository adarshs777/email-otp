...
btnContinue.addEventListener('click', () => {
    ...
    const phoneNumberExist = phoneNumber.value.match(/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/g);
...
btnVerify.addEventListener('click', () => {
    ...
    if (OTP === yourInputNumber) {
        ...
        boxVerify.querySelector('p').innerHTML = "Your Email address is "+ phoneNumber.value;
